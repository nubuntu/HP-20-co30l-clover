 ...
 *
 * Disassembly of SSDT-5.aml, Sun Apr  9 11:26:52 2017
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00005409 (21513)
 *     Revision         0x02
 *     Checksum         0x4D
 *     OEM ID           "HPQOEM"
 ...
 */
DefinitionBlock ("", "SSDT", 2, "HPQOEM", "SLIC-CPC", 0x00003000)
{
    /*
     * iASL Warning: There were 11 external control methods found during
     * disassembly, but only 9 were resolved (2 unresolved). Additional
    ...
    OperationRegion (SANV, SystemMemory, 0x85A9AD98, 0x0135)
